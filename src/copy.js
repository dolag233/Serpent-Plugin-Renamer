...
const COPY = {
  'zh-CN': {
    ...
    parameters: '命名参数',
    numbering: '自动编号',
    numberingEnabled: '启用自动编号',
    numberingStart: '开始编号',
    numberingWidth: '固定位数',
    numberingFormat: '编号格式',
    numberingDirection: '编号顺序',
    numberingPosition: '编号位置',
    numberingSeparator: '编号分隔',
    numberingBefore: '文件名前',
    numberingAfter: '文件名后',
    separatorNone: '1',
    separatorBefore: '_1',
    separatorAfter: '1_',
    separatorBoth: '_1_',
    plainNumber: '1、2、3',
    paddedNumber: '0001、0002、0003',
    parenthesizedNumber: '(1)、(2)、(3)',
    directionForward: '正向编号',
    directionReverse: '反向编号',
    forward: '正向',
    reverse: '反向',
    preview: '命名预览',
    prefix: '添加前缀',
  ...
  en: {
    ...
    numberingEnabled: 'Enable auto numbering',
    numberingStart: 'Starting number',
    numberingWidth: 'Fixed width',
    numberingFormat: 'Number format',
    numberingDirection: 'Numbering order',
    numberingPosition: 'Number position',
    numberingSeparator: 'Number separator',
    numberingBefore: 'Before file name',
    numberingAfter: 'After file name',
    separatorNone: '1',
    separatorBefore: '_1',
    separatorAfter: '1_',
    separatorBoth: '_1_',
    ...
    paddedNumber: '0001, 0002, 0003',
    parenthesizedNumber: '(1), (2), (3)',
    directionForward: 'Forward numbering',
    directionReverse: 'Reverse numbering',
    forward: 'Forward',
    reverse: 'Reverse',
